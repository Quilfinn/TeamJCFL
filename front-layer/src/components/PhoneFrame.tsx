  ...
  return (
    <div className="flex min-h-full w-full items-center justify-center bg-[#1a1a1a] p-0 sm:p-6">
      <div className="relative h-[100svh] w-full max-w-[420px] overflow-hidden bg-paper sm:h-[880px] sm:rounded-[46px] sm:border-[10px] sm:border-black sm:shadow-2xl">
        {/* atmosphere — uniform warm paper, no top banding */}
        <div
          className="pointer-events-none absolute inset-0 z-0"
          style={{ background: 'linear-gradient(180deg, #f5f5f1 0%, #f2f2ee 100%)' }}
        />

        {/* status bar */}
        <div className="pointer-events-none relative z-30 flex h-10 items-center justify-between px-7 text-[13px] font-semibold text-ink">
        ...
        <div className="no-scrollbar relative z-10 h-[calc(100%-2.5rem)] overflow-y-auto">
          {children}
        </div>
